...
import { FaTumblr, FaQuoteLeft } from 'react-icons/fa'
  ...
  return (
    <div className="App">
      <div className="quote_wrapper">
        <div id="quote-box">
          <div id="text">
            <FaQuoteLeft /> { currentQuote.quote }
          </div>
          <div id="author">
            - { currentQuote.author }.
          </div>
          <div className='footer'>
            <div className='icons'>
              <button><a href={`htpps://twitter.com/intent/tweet?hashtags=quotes&related=haroldtchegnon&text=${currentQuote.quote}`} target="_blank" id="tweet-quote" rel='noreferrer'><FiTwitter /></a></button>
              <button><a href={`https://www.tumblr.com/widgets/share/tool?posttype=quote&tags=quotes,haroldtchegnon&caption=${currentQuote.author}&content=${currentQuote.quote}&canonicalUrl=https://www.tumblr.com?buttons&shareSource=tumblr_share_button`}><FaTumblr /></a></button>
            </div>
